		...
		return '<a class="' + classes.join(' ') + '"' +
			...
			'>' +
				...
				(timeText ?
					...
					'>' +
						'<span style="font-size: 12px;"><b>Hora:</b> ' + event.extraData.horainit + '</span>' +
						(event.aas == 1 ? '' : '<i class="fa fa-'+(event.estNoti == 0 ? 'bell-o' : 'bell')+'" style="float: right;padding: 2px 3px;"></i>') +'</div>' :
					''
					) +
					//aqui se edita el evento html
				(event.title ?
					'<div class="fc-title"><b>' +
						htmlEscape(event.title) +
					'</b> <br/> <i class="fa fa-'+(event.observaciones == 'NO' ? 'comment-o' : 'comment')+'" id="fa'+event.id+'"></i> <b>Obs.: </b> <span id="ob'+event.id+'">'+event.observaciones+'</span> ' +  (event.aas != 1 ? ' <br/> <i class="fa fa-eraser" id="fa'+event.id+'"></i> <b>Borrador </b> <span id="borr'+event.id+'">'+event.borrador+'</span>' : '') + '<br/> <i class="fa fa-calendar"></i> <b>'+event.stateEvents+'</b></div>' :
					''
					) +
				'</div>' +
			...
			'>' +
				'<div class="fc-content">' +
					(timeText ?
						...
						//aqui se edita el evento html
					(event.title ?
						'<div class="fc-title"><b>Psicólogo: ' +
							htmlEscape(event.title) +
						'</b> <br/> <b><i class="fa fa-calendar"></i> Cita: </b>'+event.stateEvents+'</div>' :
						''
						) +
				'</div>' +
				'<div class="fc-bg"/>' +
