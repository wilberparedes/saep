		...
		<td>
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%">
				...
				<tr>
					...
					<td style="'.$child.'">'.$dataEntrevista['estrato'].'</td>
				...
				if($dataEntrevista['requisitosmv']){
					...
					<tr>
						...
						<td style="'.$child.'" colspan="3">'.$dataEntrevista['codprograma'].' - '.$dataEntrevista['nombreprograma'].'</td>
					</tr>';
				}
	$html .= '</table>
		</td>
			...
			$html .= '
					...
					foreach ($value{'conceptos'} as $key => $concepto) {
						...
						<tr>
							...
							<td style="'.$child.'; width: 25%">'.$entrevista['respuestas'][$indexRespuesta]['observacion'].'</td>
	...
	<tr>
		<td>
			<table border="1" cellpadding="5" cellspacing="0" style="width:100%">
				...
				<tr>
					<td style="'.$child.'; font-weight: bold;" colspan="2">'.mb_strtoupper($dataEntrevista['conclusionesentrevista'],'utf-8').'</td>
				</tr>
			</table>
		</td>
	</tr>';
